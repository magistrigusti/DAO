...
export const contractNodes = [
  ...
  },
  {
    ...
    links: [{ id: "wallet", label: "кошельки гиверов" }],
  },
  {
    id: "wallet",
    title: "wallet",
    ...
    links: [
      ...
      { id: "giver_defi", label: "уведомление" },
  ...
  },
  {
    ...
    summary: [
      "Гивер Dominum.",
      "Делит поток 50/50 по whitelist.",
    ],
    ops: ["OP_TRANSFER_NOTIFICATION"],
    links: [
  ...
  },
  {
    id: "giver_defi",
    title: "giver_defi",
    path: "contracts/Dominum/givers/giver_defi.tolk",
    status: "wip",
    summary: [
      "Гивер для DeFi модуля.",
      "Пока используется как заготовка.",
    ],
    ops: ["OP_TRANSFER_NOTIFICATION"],
    links: [{ id: "giver_manager", label: "управление whitelist" }],
  },
  {
    id: "giver_manager",
    title: "giver_manager",
  ...
  },
  {
    ...
    status: "ok",
    summary: [
      "Управляет Gas Pool и казначействами.",
      "Админ — Bank Dominum.",
    ],
  ...
  },
  {
    id: "bank_dao",
    title: "bank_dao",
    path: "contracts/Dominum/banks/bank_dao.tolk",
    status: "ok",
    summary: [
      "Банк DAO, принимает поток от giver_dao.",
      "Используется в DAO-логике.",
    ],
  },
  {
    id: "bank_dominum",
    title: "bank_dominum",
    path: "contracts/Dominum/banks/bank_dominum.tolk",
    status: "draft",
    summary: [
      "Банк Dominum.",
      "Пока в формате заготовки.",
    ],
  ...
  },
  {
    id: "bank_invest",
    title: "bank_invest",
    path: "contracts/Dominum/banks/bank_invest.tolk",
    status: "draft",
    summary: [
      "Банк Invest.",
      "Используется вместе с dual_sign.",
    ],
    links: [{ id: "dual_sign", label: "двойная подпись" }],
  },
  {
    id: "dao_foundation",
    ...
    summary: [
      "Фонд DAO.",
      "Принимает половину потока от giver_dao.",
    ],
  },
  {
    id: "dual_sign",
    title: "dual_sign",
    path: "contracts/Dominum/invest/dual_sign.tolk",
    status: "ok",
    summary: [
      "Контракт с двойной подписью.",
      "Используется в Invest-цепочке.",
    ],
  },
  {
  ...
  },
  {
    ...
    summary: [
      "Фонд Allodium.",
      "Получает поток от giver_allodium.",
    ],
  },
];

const entries = contractNodes.map((node) => [node.id, node]);
export const contractMap = Object.fromEntries(entries);
...
export const contractGroups = [
  {
    ...
    sections: [
      ...
      },
      {
        id: "dominum-banks",
        title: "banks",
        nodes: ["bank_dao", "bank_dominum", "bank_invest"],
      },
      {
        id: "dominum-dao",
        title: "dao",
        nodes: ["dao_foundation"],
      },
      {
        id: "dominum-invest",
        title: "invest",
